 ...
 * [quay.yml](quay.yml)
     * Determines how your purl.obolibrary.org/obo/quay/ redirects will be handled
     ...
     * Paste in the contents of [quay.yml](quay.yml)
 ...
 * [quay.md](quay.md)
     ...
     * Paste in the contents of [quay.md](quay.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
